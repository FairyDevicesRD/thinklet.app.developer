...
export const button_explanation_word_list_thinklet = [
...
export const button_explanation_word_list_thinklet_cube = [
  "(1) `KEYCODE_VOLUME_DOWN` がアサインされたボタン",
  "(2) `KEYCODE_CAMERA` がアサインされたボタン",
  "(3) `KEYCODE_VOLUME_UP` がアサインされたボタン",
  "(4) `KEYCODE_POWER` がアサインされたボタン。常に短押しでHomeに戻る動作をします",
...
export const button_explanation_word_thinklet = button_explanation_word_list_thinklet.join('<br />');
export const button_explanation_word_thinklet_cube = button_explanation_word_list_thinklet_cube.join('<br />');
...
<img
  src={require('./img/hw/lc-01/tl.jpg').default}
...
| ---------- | ---------- |
|{parse(button_explanation_word_thinklet)}|{parse(button_explanation_word_thinklet_cube)}|
...
| <img src={require('./img/hw/lc-01/d.jpg').default} style={{ width: '500px'}} /> | <img src={require('./img/hw/lc-02/d.jpg').default} style={{ width: '500px'}} /> |
| <img src={require('./img/hw/lc-01/up.jpg').default} style={{ width: '500px'}} /> | <img src={require('./img/hw/lc-02/f.jpg').default} style={{ width: '500px'}} /> |
